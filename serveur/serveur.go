...
func main() {
	...
	serverCert := flag.String("srvcert", "localhost.crt", "Required, the name of the server's certificate file")
	caCert := flag.String("cacert", "ExempleCA.crt", "Required, the name of the CA that signed the client's certificate")
	srcKey := flag.String("srvkey", "localhost.key", "Required, the file name of the server's private key file")
